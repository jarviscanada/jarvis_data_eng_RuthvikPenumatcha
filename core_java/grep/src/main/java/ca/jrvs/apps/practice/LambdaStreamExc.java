...
public interface LambdaStreamExc {
   ...
   * e.g. filter(stringStream, "a") will return another stream in which no element contains a
   * @param stringStream
   * @param pattern
   * @return
   */
  ...
  /**
   * Create a IntStream range from start to end
   * @param start
   * @param end
   * @return
   */
  ...
  /**
   * Convert a intStream into doubleStream and compute square root of each element
   * @param intStream
   * @return
   */
  ...
  /**
   * filter all even numbers and return odd numbers from a intStream
   * @param intStream
   * @return
   */
