...
**Software Developer, Jarvis (2025-present)**: As a software developer, I contribute to multiple projects using technologies such as Linux, Bash scripting, PostgreSQL, Docker, and Git. I play an active role in designing, implementing, and deploying scalable solutions that meet client needs. I collaborate closely with a cross-functional team in an Agile/Scrum environment, participating in sprint planning, daily stand-ups, sprint reviews and retrospectives.
